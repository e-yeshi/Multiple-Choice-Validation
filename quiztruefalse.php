<html>
	<head>
		<title>Practicum 2 True False</title>
	...
	if (($handle = fopen("questions.txt", "r")) !== FALSE) {
		...
		if (($handle = fopen("answersoptions.txt", "r")) !== FALSE) {
			while (($data = fgetcsv($handle, 1000, ":")) !== FALSE)
				{
					if($data[0] == 'q01'){
    ...
    <div class= "col-md-12 col-lg-12 main-containor">
      ...
      <form action="quiztruefalse.php" method="post">
        <div class="head row">
